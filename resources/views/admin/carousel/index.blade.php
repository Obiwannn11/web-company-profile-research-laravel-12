...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.carousels.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">+ Tambah Slide Baru</a>
    </div>
            ...
            <tbody class="text-gray-600">
                @forelse ($carousels as $slide)
                    <tr class="border-b hover:bg-gray-50">
                        <td class="px-4 py-3"><img src="{{ asset('storage/' . $slide->image) }}" alt="Slide" class="h-16 w-auto object-cover"></td>
                ...
                @empty
                    <tr><td colspan="4" class="text-center py-5">Belum ada slide carousel.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
