...
@section('content')
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Tambah FAQ Baru</h1>
            ...
            <div x-data="{ activeTab: 'id' }">
                ...
                <div x-show="activeTab === 'id'" class="mt-6 space-y-6">
                    <div>
                        ...
                        <textarea name="translations[id][question]" id="question_id" rows="3" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                    <div>
                        <label for="answer_id" class="block text-sm font-medium text-gray-700">Jawaban (ID)</label>
                        <textarea name="translations[id][answer]" id="answer_id" rows="5" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                </div>
                ...
                <div x-show="activeTab === 'en'" class="mt-6 space-y-6">
                    <div>
                        ...
                        <textarea name="translations[en][question]" id="question_en" rows="3" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                    <div>
                        <label for="answer_en" class="block text-sm font-medium text-gray-700">Answer (EN)</label>
                        <textarea name="translations[en][answer]" id="answer_en" rows="5" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                </div>
            </div>
