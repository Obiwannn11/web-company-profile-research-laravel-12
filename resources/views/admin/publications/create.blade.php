...
@section('content')
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Publikasi Baru</h1>
            ...
            <div x-data="{ activeTab: 'id' }">
                ...
                <div x-show="activeTab === 'id'" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="translations[id][content]" id="content_id" rows="10" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                </div>
                ...
                <div x-show="activeTab === 'en'" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="translations[en][content]" id="content_en" rows="10" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                </div>
            </div>
