...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10">
        ...
        <a href="{{ route('admin.carousels.index') }}" class="flex items-center px-6 py-2 mt-4 text-gray-100 hover:bg-gray-600 {{ request()->routeIs('admin.carousels.*') ? 'bg-gray-700 bg-opacity-75' : '' }}">
        <span class="mx-3">Kelola Carousel</span>
        </a>
